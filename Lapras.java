...
public class Lapras extends Creature
{
    ...
    public void attack(int idx)
    {
        ...
        else
        {
            if(enemyType == "Fire")
            {
                ...
                getWorld().showText("THE ATTACK WAS SUPPORT EFFECTIVE!",getWorld().getWidth()/2,getWorld().getHeight()/2+26);
                Greenfoot.delay(30);
            }
            ...
            if(enemyType.equalsIgnoreCase("Grass"))
            {
                 ...
                 *          and a y location of half the height of the world plus 26 pixels
                 */
                getWorld().showText("THE ATTACK WAS SUPER AFFECTIVE!",getWorld().getWidth()/2,getWorld().getHeight()/2+26);
    ...
    public void switchCreature(int idx)
    {
        ...
        if(getHealthBar().getCurrent() <= 0)
        {
            JOptionPane.showInputDialog(null, "the Creature you have chosen to switch to has fainted please select a different creature!");
        }
        else
        {
