...
public class CreatureWorld extends World
{
     ...
     */
    /**
     * changePlayerOne is the method used for removing the menus and setting them to false.
     * 
     * @params - There is one parameter that is String used for playerOneCreature.
     ...
     */
    /**
     * getNewOneCreature is the method used for getting a new one player and returning it as an array.
     * 
     * @params - There is one integer parameter for index.
     ...
     */
    /**
     * getNewTwoCreature is the method used for getting a new two player and returning it as an array.
     * 
     * @params - There is one integer parameter for index.
     * @returns - There are no return types.
     */
